...
//Code Here
let evenNumbers = mixedNumbers.filter((e, i, a) => e % 2 === 0); // = mixedNumbers.filter(/* Provide Your Callback Here */)
...
//Code Here
let postTaxPrices = prices.map(e => e * 1.07);// = prices.map(/* Provide Your Callback Here );
...
let ordersTotal = orders.map(order => order.price + order.price * order.tax); //Code Here
...
/*
  Use a high order method to create to get the sum of Bob's Total.
*/
